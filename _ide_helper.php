...
namespace Illuminate\Support\Facades {
     ...
     */        class Response {
         ...
         * 
         *
         * @see \App\Providers\ResponseServiceProvider::descriptiveResponseMethods()
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::ok($data, $message, $status);
        }
                    /**
         * 
         *
         ...
         * @param int $status
         * @static 
         */        public static function notifyOk($data = [], $message = 'Success', $notifyType = 'positive', $status = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::notifyOk($data, $message, $notifyType, $status);
        }
                    /**
         * 
         *
         ...
         * @param mixed $errors
         * @static 
         */        public static function forbidden($message = 'Access denied', $errors = [])
        {
                        return \Illuminate\Routing\ResponseFactory::forbidden($message, $errors);
        }
                    /**
         * 
         *
         ...
         * @param string $notifyType
         * @static 
         */        public static function notifyForbidden($message = 'Access denied', $errors = [], $notifyType = 'negative')
        {
                        return \Illuminate\Routing\ResponseFactory::notifyForbidden($message, $errors, $notifyType);
        }
                    /**
         * 
         *
         ...
         * @param mixed $status
         * @static 
         */        public static function error($message = 'Error.', $errors = [], $status = 422)
        {
         ...
         * @param mixed $status
         * @static 
         */        public static function notifyError($message = 'Error.', $errors = [], $notifyType = 'negative', $status = 422)
        {
                        return \Illuminate\Routing\ResponseFactory::notifyError($message, $errors, $notifyType, $status);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::notFound($message, $errors);
        }
                    /**
         * 
         *
         ...
         * @param mixed $notifyType
         * @static 
         */        public static function notifyNotFound($message = 'Not Found.', $errors = [], $notifyType = 'negative')
        {
                        return \Illuminate\Routing\ResponseFactory::notifyNotFound($message, $errors, $notifyType);
        }
            }
            /**
     * 
